...
public sealed partial class GrayscaleSettingsViewModel : ObservableObject, IDisposable
{
    ...
    public GrayscaleSettingsViewModel(ProcessorSettings<GrayscaleOptions> settings)
    {
        _settings = settings;
    ...
    private void OnSettingsChanged(object? sender, GrayscaleOptions options) => Enabled = options.Enabled;
